...
@section('content')
    ...
    <h2>Stanford University Gown <span><a class="btn btn-outline-dark pull-right" href="/inventory">Go back</a></span></h2>
    <br />
    <table class="table table-bordered table-hover">
        <thead>
        <tr>
            <th scope="col">Gowns - 2018/2019</th>
        ...
        <tbody>
        @foreach($posts_columns as $post_column)

            <tr>
            <td>{{$post_column->gowns_2018_2019}}</td>
            ...
            <td><a id="btnEdit" href="/stanford_university/{{$post_column->id}}/edit" class="btn btn-primary">Edit</a></td>
            </tr>
