...
@section('content')
    ...
    <h2>Stanford University 2017 Gown <span><a class="btn btn-outline-dark pull-right" href="/inventory">Go back</a></span></h2>
    <br />
    <table class="table table-bordered table-hover">
        <thead>
        <tr>
            <th scope="col">Gowns - 2017</th>
        ...
        @foreach($data as $post_column)
            ...
            <tr>
                ...
                <td><a id="btnEdit" href="/stanford_university_2017/{{$post_column->id}}/edit" class="btn btn-primary">Edit</a></td>
            </tr>
